...
"Win + c" "開啟工作空間列表/視窗列表" "#ffffff" "Monospace 16" \
"Win + Space" "開啟桌面功能選單" "#cccccc" "Monospace 16" \
"Alt + Space" "開啟目前聚焦視窗功能選單" "#ffffff" "Monospace 16" \
"Alt + Shift + d" "開啟 Rofi Drun" "#cccccc" "Monospace 16" \
"Alt + Shift + r" "開啟 Rofi Run" "#ffffff" "Monospace 16" \
"Alt + Shift + w" "開啟 Rofi Window" "#cccccc" "Monospace 16" \
"Alt + Shift + f" "開啟檔案管理器 (thunar)" "#ffffff" "Monospace 16" \
"Alt + Shift + g" "開啟檔案管理器 (pcmanfm-qt)" "#cccccc" "Monospace 16" \
"Alt + Shift + e" "開啟 (mousepad)" "#ffffff" "Monospace 16" \
"Alt + Shift + b" "開啟網頁瀏覽器 (firefox)" "#cccccc" "Monospace 16" \
"Alt + Shift + s" "開啟系統設定 (xfce4-settings-manager)" "#ffffff" "Monospace 16" \
"Alt + Ctrl + s" "開啟系統設定值編輯器 (xfce4-settings-editor)" "#cccccc" "Monospace 16" \
"Win + Shift + s" "開啟視窗管理器設定 (xfwm4-settings)" "#ffffff" "Monospace 16" \
"Win + Ctrl + s" "開啟外觀設定 (xfce4-appearance-settings)" "#cccccc" "Monospace 16" \
"Ctrl + Esc" "開啟程序管理器 (xfce4-taskmanager)" "#ffffff" "Monospace 16" \
"Win + p" "開啟螢幕解析度設定 (xfce4-display-settings --minimal)" "#cccccc" "Monospace 16" \
"Alt + Enter" "開啟 Terminal (xfce4-terminal)" "#ffffff" "Monospace 16" \
"Alt + Shift + a" "開啟 Terminal (xfce4-terminal)" "#cccccc" "Monospace 16" \
"Alt + Ctrl + a" "開啟 Terminal (sakura)" "#ffffff" "Monospace 16" \
"Alt + Shift + t" "開啟 Terminal (xterm)" "#cccccc" "Monospace 16" \
...
"Win + r" "視窗 / 開始更改大小" "#cccccc" "Monospace 16" \
"Win + t" "視窗 / 保持永遠在最上方" "#ffffff" "Monospace 16" \
"Win + y" "視窗 / 內容區塊收合" "#cccccc" "Monospace 16" \
...
"Alt + Ctrl + 1-9" "切換至工作空間 1-9" "#ffffff" "Monospace 16" \
"Alt + Shift + 1-9" "將視窗移至工作空間 1-9" "#cccccc" "Monospace 16" \
